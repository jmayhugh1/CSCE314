...
public class Main {
  ...
  // (see the sample output in the assignment description)
  System.out.println("The shapes sorted by area are:");
    Arrays.sort(shapes);
    for (Shape e : shapes) { out.println(e); }
  // output the total area of all the shapes
  System.out.println("The total area of  shapes is: " + TotalAreaCalculator.calculate(shapes));
